...
$result_set = find_all_results();
    ...
    <div class="w3-bar-block">
        ...
        <a href="<?php echo url_for("user/galas.php?id=".$user['Id']);?>" class="w3-bar-item w3-button w3-padding w3-teal"><i class="fa fa-trophy fa-fw"></i>  All Galas</a>
    </div>
    </nav>
...
<div class="w3-panel">
    ...
    <td><a href="<?php echo url_for("user/gala_results.php?id=".$gala['Id']);?>" class="w3-button w3-teal"> Results</a>
</td>
    </tr>
    <?php } ?>
    </table>
