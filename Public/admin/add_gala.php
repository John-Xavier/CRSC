<?php
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-trophy"></i> Add Gala</b></h5>
    </header>



<div class="w3-container w3-padding">
<form action="<?php echo url_for('/admin/add_gala.php'); ?>" method="post">
    <div class="w3-padding">
<label>Gala Name</label>
<input class="w3-input" name="gala_name"  type="text">
</div>
<div class="w3-padding">
...
<div class="w3-padding">
<label>From</label>
<input class="w3-input" name="time_from"  type="text">
</div>
<div class="w3-padding">
<label>To</label>
<input class="w3-input" name="time_to"  type="text">
</div>
