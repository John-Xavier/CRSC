...
<a href="<?php echo url_for("admin/add_performance.php");?>" class="w3-button w3-teal">Add Performance <i class="fa fa-light fa-plus"></i></a>

</div>
  <div class="w3-container">
  <form action="<?php echo url_for('/admin/performance.php');?>" method="post">
...
<?php while($performance = mysqli_fetch_assoc($performance_set)){?>
    ...
    <td><a href="<?php echo url_for("admin/edit_performance.php?id=".$performance['Id']);?>" class="w3-button w3-teal">Edit</a></td>
    <td><a href="<?php echo url_for("admin/delete_performance.php?id=".$performance['Id']);?>" class="w3-button w3-red">Delete</a></td>
