...
<form action="<?php echo url_for('/admin/delete_performance.php?id=' . $id); ?>" method="post">
    <div class = "w3-conatainer w3-padding w3-cell">
        <input class = "w3-button w3-red" type="submit" name="commit" value="Delete"/>
</div>
<div class = "w3-conatainer w3-padding w3-cell">
<a href="<?php echo url_for("admin/performance.php");?>" class="w3-button w3-teal">Cancel</a>
</div>
