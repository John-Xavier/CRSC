...
<a href="<?php echo url_for("admin/add_gala.php");?>" class="w3-button w3-teal">Add Gala <i class="fa fa-light fa-plus"></i></a>
    ...
    <?php while($gala = mysqli_fetch_assoc($gala_set)){?>
     <tr>
    <td><?php echo h($gala['gala_name']); ?></td>
    <td><?php echo h($gala['description']); ?></td>
    <td><a href="<?php echo url_for("admin/gala_results.php?id=".$gala['Id']);?>" class="w3-button w3-teal"> Results</a>
    <td><a href="<?php echo url_for("admin/view_gala.php?id=".$gala['Id']);?>" class="w3-button w3-teal">View</a></td>
    <td><a href="<?php echo url_for("admin/edit_gala.php?id=".$gala['Id']);?>" class="w3-button w3-teal">Edit</a></td>
    <td><a href="<?php echo url_for("admin/delete_gala.php?id=".$gala['Id']);?>" class="w3-button w3-red">Delete</a></td>
    ...
    <footer class="w3-container w3-padding-16 w3-light-grey">
        <p>College Road Swimming Club</p>
        <p>Copyrights 2023</p>
    </footer>
