    ...
    <a href="<?php echo url_for("coach/galas.php");?>" class="w3-bar-item w3-button w3-padding"><i class="fa fa-solid fa-trophy"></i></i>  Galas</a>
        ...
        <header class="w3-container" style="padding-top:22px">
            <h5><b><i class="fa fa-user"></i> Add Performance</b></h5>
        </header>



    <div class="w3-container w3-padding">
    <form action="<?php echo url_for('/coach/add_performance.php'); ?>" method="post">
        <div class="w3-padding">
    <label>Week</label>
    <input class="w3-input" name="week"  type="text">
    </div>
    <div class="w3-padding">
    <label>Backstroke</label>
    <input class="w3-input" name="backstroke"  type="text">
    </div>
    <div class="w3-padding">
    <label>Breaststroke</label>
    <input class="w3-input" name="breaststroke"  type="text">
    </div>
    <div class="w3-padding">
    <label>Butterfly</label>
    <input class="w3-input" name="butterfly"  type="text">
    </div>
    <div class="w3-padding">
    <label>Sidestroke</label>
    <input class="w3-input" name="sidestroke"  type="text">
    </div>
    <div class="w3-padding">
